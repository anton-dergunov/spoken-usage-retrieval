...
| --- | --- | --- | --- |
| [Ten-language morphology and compact index](morphological-retrieval-multilingual/README.md) | 2026-09-06 | Complete | Stanza led coverage-adjusted quality in all ten languages; token positions preserved retrieval semantics while reducing measured storage by 85.1%. |
